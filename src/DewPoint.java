...
public class DewPoint extends JFrame {
    ...
    DewPoint(String applicationTitle) throws IOException {
    ...
    public XYSeriesCollection createDataset() throws NumberFormatException,
        ...
        try {
            ...
            // Set up series
            final XYSeries seriesX = new XYSeries("Dew Point");
            ...
            while ((readNextLine = reader.readNext()) != null) {
                ...
                double dewpoint = Double.valueOf(readNextLine[13]);

                seriesX.add(cases, dewpoint);}
    ...
    public JFreeChart createChart(XYDataset dataset)
        ...
        chart = ChartFactory.createXYLineChart("Dew Point vs Number of Cases", // chart
                                                                        // title
                "Number of Cases", // domain axis label
                "Dew Point", // range axis label
                dataset, // data
