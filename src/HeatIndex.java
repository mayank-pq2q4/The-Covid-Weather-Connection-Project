...
public class HeatIndex extends JFrame {
    ...
    XYSeries series;
        ...
        HeatIndex(String applicationTitle) throws IOException {
    ...
    public XYSeriesCollection createDataset() throws NumberFormatException,
        ...
        try {
            ...
            // Set up series
            final XYSeries seriesX = new XYSeries("Heat Index");
            ...
            while ((readNextLine = reader.readNext()) != null) {
                ...
                double heatindex = Double.valueOf(readNextLine[14]);

                seriesX.add(cases, heatindex);}
    ...
    public JFreeChart createChart(XYDataset dataset)
        ...
        chart = ChartFactory.createXYLineChart("Heat Index vs Number of Cases", // chart
                                                                        // title
                "Number of Cases", // domain axis label
                "Heat Index", // range axis label
                dataset, // data
